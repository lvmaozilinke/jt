...
import com.example.wangpengfei2.dialog.LifeIndicatorDialog;
...
//			mCo2Tv.setText(arg0.optInt("co2"));	
	...
	private void InitView() {
		...
		mlifebtn=(TextView) getView().findViewById(R.id.Life_bt);
...
//			LifeIndicatorDialog mDialog=new LifeIndicatorDialog(getActivity(), light, temperatur, co2, pm, humidity);
//			mDialog.show(getActivity().getFragmentManager(), "LifeIndicatorDialog");
				LifeIndicatorDialog mDialog=new LifeIndicatorDialog(getActivity(), light, temperatur, co2, pm, humidity);
				mDialog.show(getActivity().getFragmentManager(), "ad");
