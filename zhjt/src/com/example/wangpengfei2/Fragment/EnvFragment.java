...
//			mCo2Tv.setText(arg0.optInt("co2"));	
	...
	private void InitView() {
		...
		mlifestr=(Button) getView().findViewById(R.id.Life_bt);
		mlifestr.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View arg0) {
				Base dialog=new Base(EnvFragment.this);
				dialog.setCancelable(true);
				
				dialog.show(getChildFragmentManager(), "LifeIndicatorDialog ");
