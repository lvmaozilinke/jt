...
public void getStationInfo(int stationId,Listener<JSONObject>listener,ErrorListener errorlistener){
	...
	mQueue.add(new JsonObjectRequest(Request.Method.POST,mServerIp+"GetBusStationInfo.do"
			,jsonObject
			,listener
			,errorlistener));
	}
